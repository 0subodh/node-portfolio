...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour name must have mininum 10 characters'],
      /*
      validate: {
        validator: validator.isAlpha,
        message: 'A tour name should only contain characters',
      },
      */
    },
    slug: String,
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficlty is either easy, medium or difficult',
      },
    },
    ratingsAverage: {
      type: Number,
